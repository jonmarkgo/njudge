/*
 * $Log: dip.h,v $
 * Revision 1.58  2010-08-18 00:01:21  chrisb
 * Bug 293 - Extend game names to 20 bytes
 * Misc - Flags to enable stricter password behaviors
 *
...
typedef enum {
	...
	DIP_INIT_ERROR_MISSING_ARG = 1,
	DIP_INIT_ERROR_VOID_OPTION,
	DIP_INIT_ERROR_OPEN_STREAM,
	DIP_INIT_ERROR_ARG_TYPE,
	DIP_INIT_ERROR_VOID_DIR,
	DIP_INIT_ERROR_LOG_OPEN,
	DIP_INIT_ERROR_LOG_FDOPEN,
	DIP_INIT_ERROR_LOG_LOCK,
	DIP_INIT_ERROR_FDOPEN,
	DIP_INIT_ERROR_HAS_BAILED,
	DIP_INIT_ERROR_HAS_CRASHED,
	DIP_INIT_ERROR_BLOCK,
	DIP_INIT_ERROR_CONTROL_FILE,
